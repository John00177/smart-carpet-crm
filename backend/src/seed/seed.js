...
const products = [
  { name_uz: 'Guliston', name_ru: 'Гулистан', size: '2x3m', color: 'Red', cost_price: 50, sell_price: 75, retail_price: 100, unit_type: 'piece' },
  { name_uz: 'Buxoro', name_ru: 'Бухара', size: '3x4m', color: 'Blue', cost_price: 80, sell_price: 120, retail_price: 160, unit_type: 'piece' },
  { name_uz: 'Samarqand', name_ru: 'Самарканд', size: '2x3m', color: 'Green', cost_price: 60, sell_price: 90, retail_price: 120, unit_type: 'piece' },
  // Roll carpets, sold by the metre.
  { name_uz: 'Xiva', name_ru: 'Хива', size: '4x6m', color: 'Red', cost_price: 12, sell_price: 18, retail_price: 24, unit_type: 'meter' },
  { name_uz: 'Qashqadaryo', name_ru: 'Кашкадарья', size: '3x4m', color: 'Beige', cost_price: 70, sell_price: 105, retail_price: 140, unit_type: 'piece' },
  { name_uz: "Farg'ona", name_ru: 'Фергана', size: '2x3m', color: 'Brown', cost_price: 55, sell_price: 82, retail_price: 110, unit_type: 'piece' },
  { name_uz: 'Andijon', name_ru: 'Андижан', size: '3x5m', color: 'Gold', cost_price: 6, sell_price: 9, retail_price: 12, unit_type: 'meter' },
  { name_uz: 'Namangan', name_ru: 'Наманган', size: '2x2m', color: 'Blue', cost_price: 40, sell_price: 60, retail_price: 80, unit_type: 'piece' },
  { name_uz: 'Surxondaryo', name_ru: 'Сурхандарья', size: '4x4m', color: 'Red', cost_price: 100, sell_price: 150, retail_price: 200, unit_type: 'piece' },
  { name_uz: 'Jizzax', name_ru: 'Джизак', size: '2x3m', color: 'Green', cost_price: 45, sell_price: 67, retail_price: 90, unit_type: 'piece' },
];
